...
- `skill`: Update the skill file (`inhtml.md`) with typography rules, layout guidance, expanded pattern references, and the "when in doubt" heuristic

## Impact

- `.claude/commands/inhtml.md` — rewritten with richer content
